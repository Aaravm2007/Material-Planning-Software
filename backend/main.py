...
from app.api.allotments import router as allotments_router
...
async def _run_migrations():
    ...
    migrations = [
        ...
        "ALTER TABLE material_rows ADD COLUMN customs_rate VARCHAR",
        "ALTER TABLE shipping_options ADD COLUMN is_selected BOOLEAN DEFAULT 0",
        "ALTER TABLE material_rows ADD COLUMN bond_parent_uid VARCHAR(36)",
        "ALTER TABLE material_rows ADD COLUMN exbond_boe_no VARCHAR",
        "ALTER TABLE material_rows ADD COLUMN exbond_quantity VARCHAR",
        "ALTER TABLE allotments ADD COLUMN model_number VARCHAR",
        "ALTER TABLE material_rows ADD COLUMN advance_currency VARCHAR",
        "ALTER TABLE material_rows ADD COLUMN advance_rate VARCHAR",
        "ALTER TABLE material_rows ADD COLUMN advance_inr VARCHAR",
        "ALTER TABLE material_rows ADD COLUMN estimated_etd VARCHAR",
        "ALTER TABLE material_rows ADD COLUMN allocated_month VARCHAR",
    ]
...
app.include_router(branches_router,         dependencies=_auth)
app.include_router(allotments_router,       dependencies=_auth)
